---
name: gc-bug-reproduction-validator
...
2. **Systematic Reproduction Process**:
   ...
   - For UI bugs, examine the scene tree and node properties
   - For backend bugs, examine logs and resource states
...
4. **Investigation Techniques**:
   ...
   - Examine resource constraints and node configurations
   - Check Godot editor output and debug logs
