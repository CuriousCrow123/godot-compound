---
name: gc-best-practices-researcher
...
<examples>
<example>
Context: User wants to know the best way to structure GitHub issues for their Godot project.
user: "I need to create some GitHub issues for our project. Can you research best practices for writing good issues?"
assistant: "I'll use the gc-best-practices-researcher agent to gather comprehensive information about GitHub issue best practices, including examples from successful projects and Godot-specific conventions."
<commentary>Since the user is asking for research on best practices, use the gc-best-practices-researcher agent to gather external documentation and examples.</commentary>
</example>
<example>
Context: User is implementing a save system and wants to follow best practices.
user: "We're adding a save/load system to our Godot game. What are the current best practices?"
assistant: "Let me use the gc-best-practices-researcher agent to research current Godot save system best practices, Resource serialization patterns, and file handling considerations."
<commentary>The user needs research on best practices for a specific technology implementation, so the gc-best-practices-researcher agent is appropriate.</commentary>
</example>
</examples>
...
2. **Identify Relevant Skills**:
   ...
   - Godot/GDScript → `brainstorming`, `compound-docs`
   - AI/Agents → `create-agent-skills`
